...
Aplikasi ini merupakan dashboard sederhana LMS (Learning Management System) yang digunakan untuk menampilkan daftar tugas mahasiswa. Tampilan aplikasi menggunakan `GridView` pada bagian atas untuk menampilkan dua tugas dengan deadline terdekat secara berdampingan, kemudian dilanjutkan menggunakan `ListView.separated` pada bagian bawah untuk menampilkan delapan daftar tugas lainnya lengkap dengan informasi mata kuliah, deadline, dan status tugas.

Penggunaan `GridView` mempermudah pengguna dalam melihat tugas prioritas dengan cepat, sedangkan `ListView.separated` membuat tampilan daftar tugas lebih rapi karena terdapat jarak pemisah antar item.

# Output

<p align="center">
  <img width="1920" height="1080" alt="Output" src="https://github.com/user-attachments/assets/d71e6df0-d82a-4ca7-9038-3913bf9dc268" />
</p>